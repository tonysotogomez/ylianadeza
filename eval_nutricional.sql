...
--
-- Servidor: localhost
-- Tiempo de generación: 25-01-2016 a las 04:33:25
...
CREATE TABLE IF NOT EXISTS `alumno` (
  ...
  `idTalla` int(3) NOT NULL,
  `idPeso` int(3) NOT NULL,
  `idAula` int(2) DEFAULT NULL,
  `idDiagnostico` int(5) NOT NULL,
  `nro` int(5) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `Edad` (`idEdad`) USING BTREE,
  KEY `Talla` (`idTalla`) USING BTREE,
  KEY `Peso` (`idPeso`) USING BTREE,
  KEY `Diagnostico` (`idDiagnostico`) USING BTREE,
...
INSERT INTO `alumno` (`id`, `idEdad`, `idTalla`, `idPeso`, `idAula`, `idDiagnostico`, `nro`, `nombres`, `apellidos`, `fecha_nacimiento`, `genero`, `titular`, `estado`, `register_at`, `update_at`) VALUES
(1, 0, 0, 0, 1, 0, 1, 'mia luciana', 'BRAVO OROPEZA', '2015-07-06', 'm', 'BRAVO HURTADO MANUEL EDUARDO', 1, NULL, NULL),
(2, 0, 0, 0, 1, 0, 2, 'jael mackenzie', 'ESTEBAN MERCADO', '2015-08-09', 'h', 'ESTEBAN GALVAN WILLIAM PERCY', 1, NULL, NULL),
(3, 0, 0, 0, 1, 0, 3, 'Matthew Stephano', 'GUILLEN ARANA', '2015-08-20', 'h', 'ARANA CLEMENTE SANDRA PAOLA', 1, NULL, NULL),
(4, 0, 0, 0, 1, 0, 5, 'Luciana Micaela', 'LEÓN RAMOS', '2015-07-30', 'm', 'RAMOS YDOÑA ROCIO VIVIANA', 1, NULL, NULL),
(5, 0, 0, 0, 1, 0, 6, 'Alondra Emperatriz', 'LÓPEZ AREVALO', '2015-07-10', 'm', 'AREVALO QUISPE JACKQUELINE ANTONIETA', 1, NULL, NULL),
(6, 0, 0, 0, 1, 0, 7, 'Valery Valentina', 'LÓPEZ MENDOZA', '2015-08-17', 'm', 'MENDOZA GONZALES SELMA', 1, NULL, NULL),
(7, 0, 0, 0, 1, 0, 8, 'Valeria Abigail', 'MAMANI LLAMOCA', '2015-09-21', 'm', 'MAMANI RAMOS CESAR AGUSTO', 1, NULL, NULL),
(8, 0, 0, 0, 1, 0, 9, 'Angelo Jared', 'PARIONA SUAREZ', '2015-08-14', 'h', 'SUAREZ GOMEZ DENISSE NATALY', 1, NULL, NULL),
(9, 0, 0, 0, 1, 0, 10, 'Brianna Elizabeth', 'ULLILEN FLORES', '1970-01-01', 'm', 'ULLILEN ABANTO WILLINTO', 1, NULL, NULL),
(10, 0, 0, 0, 1, 0, 4, 'Antonella Fabiana', 'JOAQUÍN HUAMÁN', '2015-08-29', 'm', 'JOAQUÍN CASTRO VICTOR WILLY', 1, NULL, NULL),
(11, 1, 0, 0, 1, 0, 11, NULL, 'AÚN NO NACE', NULL, NULL, '', 1, NULL, '2016-01-24 00:00:00'),
(12, 1, 0, 0, 1, 0, 12, NULL, 'AÚN NO NACE', NULL, NULL, '', 1, NULL, NULL),
(13, 1, 0, 0, 1, 0, 13, NULL, 'AÚN NO NACE', NULL, NULL, '', 1, NULL, NULL),
(14, 1, 0, 0, 1, 0, 15, NULL, 'AÚN NO NACE', NULL, NULL, '', 1, NULL, NULL),
(15, 1, 0, 0, 1, 0, 16, NULL, 'AÚN NO NACE', NULL, NULL, '', 1, NULL, NULL),
(16, 0, 0, 0, 2, 0, 1, 'Lucero Alondra', 'CABRERA RAMOS', '2015-06-04', 'm', 'RAMOS VERASTEGUI ANDREA MELISSA', 1, NULL, '2016-01-24 00:00:00'),
(17, 0, 0, 0, 2, 0, 2, 'Jimena Jazmín', 'CHICOMA RODIGUEZ', '2015-06-26', 'm', 'RODRIGUEZ QUISPE JANETH YOLANDA', 1, NULL, NULL),
(18, 0, 0, 0, 2, 0, 3, 'Joaquín Aaron', 'EGUZQUISA ZENDER', '2015-04-07', 'h', 'EGUZQUIZA ESTRADA JORGE LUIS', 1, NULL, NULL),
(27, 0, 0, 0, 2, 0, 4, 'Eduardo José Tomás', 'HERRERA VILLANUEVA', '2015-04-20', 'h', 'HERRERA VILLANUEVA WILFREDO TOMASINI', 1, NULL, NULL),
(28, 0, 0, 0, 2, 0, 5, 'Ariana Nicolle', 'LLONTOP CHAFLOQUE', '2015-04-27', 'm', 'LLONTOP AYASTA FRANCISCO JESUS ANTONIO', 1, NULL, NULL),
(29, 0, 0, 0, 2, 0, 6, 'Victoria Catalina', 'PASQUEL CAMACHO', '2015-06-18', 'm', 'CAMACHO MORENO BRENDA NAARA', 1, NULL, NULL),
(30, 0, 0, 0, 2, 0, 7, 'Hanna Lucero', 'PAUCAR PEREZ', '2015-05-09', 'm', 'PEREZ HUAMAN MADELEYNE ERSI', 1, NULL, NULL),
(31, 0, 0, 0, 2, 0, 8, 'Carla Ariana', 'PEREZ SANDOVAL', '2015-04-19', 'm', 'SANDOVAL FACHO MARIA ROSALINA', 1, NULL, NULL),
(32, 0, 0, 0, 2, 0, 9, 'Yuleika Rafaella', 'ROMERO CUETO', '2015-04-06', 'm', 'CUETO SALDAÑA LILIANA VICTORIA', 1, NULL, NULL),
(33, 0, 0, 0, 2, 0, 10, 'Emily Andrea', 'SÁNCHEZ RAMOS', '2015-05-07', 'm', 'SANCHEZ AURIS CARLOS MIGUEL', 1, NULL, NULL),
(34, 0, 0, 0, 2, 0, 11, 'Zoe Amira', 'SARMIENTO ORELLANA', '2015-05-23', 'm', 'ORELLANA HERNANDEZ JULIA LUZ MARLENE', 1, NULL, NULL),
(35, 0, 0, 0, 2, 0, 12, 'Flavia Ximena', 'TORRES DE LA FUENTE CHÁVEZ', '2015-04-12', 'm', 'DE LA FUENTE CHAVEZ SHUÑA PATRICIA ESPERANZA', 1, NULL, NULL),
(36, 0, 0, 0, 2, 0, 13, 'Sergio André', 'URBINA SOSA', '2015-05-07', 'h', 'URBINA AYALA SERGIO', 1, NULL, NULL),
(37, 0, 0, 0, 2, 0, 14, 'VARGAS GARCIA VIDAL', 'VARGAS OYOLO', '2015-06-22', 'h', 'Liham Edison Isai', 1, NULL, NULL),
(38, 0, 0, 0, 3, 0, 1, 'Valentino', 'ANTEZANA ZAVALA', '2015-02-19', 'h', 'ANTEZANA LLOCLLA JOHN ALEXANDER', 1, NULL, NULL),
(39, 0, 0, 0, 3, 0, 2, 'Lya Alice', 'ASAÑA COLÁN', '2015-02-19', 'm', 'COLAN FLORES GUISSELLA', 1, NULL, NULL),
(40, 0, 0, 0, 3, 0, 3, 'Nicolás Cristopher', 'CANDUELAS PAREDES', '2015-03-28', 'h', 'PAREDES PACCORI YURASI YESSENIA', 1, NULL, NULL),
(41, 0, 0, 0, 3, 0, 4, 'Mónica Brunella', 'CASTRO MAGALLANES', '2015-02-22', 'm', 'CASTRO GIRALDO HECTOR JESUS ', 1, NULL, NULL),
(42, 0, 0, 0, 3, 0, 5, 'Enzo Valentino', 'FUENTES RIVERA DAVILA', '2015-03-02', 'h', 'FUENTES RIVERA HURTADO PEDRO WILLIAM', 1, NULL, NULL),
(43, 0, 0, 0, 3, 0, 6, 'Jhosue Valentino', 'JURO RAMIREZ', '2015-02-27', 'h', 'JURO LINARES JOSE LUIS', 1, NULL, NULL),
(44, 0, 0, 0, 3, 0, 7, 'Jesús Samuel', 'MARTINEZ DÍAZ', '2015-03-18', 'h', 'DIAZ ZUTA MARIANELA', 1, NULL, NULL),
(45, 0, 0, 0, 3, 0, 8, 'Gracia Miranda', 'MARZANO CHUICA', '2015-02-25', 'm', 'MARZANO OVIEDO MIGUEL ARTURO', 1, NULL, NULL),
(46, 0, 0, 0, 3, 0, 9, 'Yaiza Rousse', 'MAURICIO ORTEGA', '2015-03-23', 'm', 'ORTEGA FLORES MERCEDES', 1, NULL, NULL),
(47, 0, 0, 0, 3, 0, 10, 'Alejandra Camila', 'MORALES ESPINOZA', '2015-03-01', 'm', 'MORALES HUAMAN SEGUNDO OMAR', 1, NULL, NULL),
(48, 0, 0, 0, 3, 0, 11, 'Thiago Patricio', 'OSCCORIMA BENDEZU', '2015-02-26', 'h', 'OSCCORIMA LEON ABEL', 1, NULL, NULL),
(49, 0, 0, 0, 3, 0, 12, 'Illari Jazmín', 'PALOMINO VILCA', '2015-02-05', 'm', 'PALOMINO COAQUIRA JOSE ANTONIO', 1, NULL, NULL),
(50, 0, 0, 0, 3, 0, 13, 'Fabio Emanuel', 'PEDRAZA MERINO', '2015-03-26', 'h', 'PEDRAZA JUANCO CARLOS ALBERTO', 1, NULL, NULL),
(51, 0, 0, 0, 3, 0, 14, 'Gianella Celeste', 'QUICIO CORZO', '2015-03-13', 'm', 'QUICIO ANDRADE EDGARD HUMBERTO', 1, NULL, NULL),
(52, 0, 0, 0, 3, 0, 15, 'Delia Valentina', 'RODRIGUEZ RANTES', '2015-02-23', 'm', 'RANTES GALLI CATHERINE LOURDES', 1, NULL, NULL),
(53, 0, 0, 0, 3, 0, 16, 'Pablo Caleb', 'ROSALES GAMARRA', '2015-02-21', 'h', 'ROSALES CASIMIRO FRANK JUNIOR', 1, NULL, NULL),
(54, 0, 0, 0, 3, 0, 17, 'Stephano Alessandro', 'SALDAÑA PONCE', '2015-02-01', 'h', 'PONCE ARAMBURU MARITZA JAZMIN', 1, NULL, NULL),
(55, 0, 0, 0, 3, 0, 18, 'Matías Rafael', 'SAONA SILVA', '2015-03-30', 'h', 'SILVA FERNANDEZ ANDREA NOHEMY', 1, NULL, NULL),
(56, 0, 0, 0, 3, 0, 19, 'Ricardo', 'ZAPATA CRUZ', '2015-02-08', 'h', 'ZAPATA RAMIREZ SEGUNDO RICARDO', 1, NULL, NULL),
(57, 0, 0, 0, 4, 0, 1, 'Danaeli del Pilar', 'ARBAIZA PINO', '2014-12-01', 'm', 'ARBAIZA REBATTA MIGUEL', 1, NULL, NULL),
(58, 0, 0, 0, 4, 0, 2, 'Dylan Miguel', 'AVILA NAVARRO', '2014-12-28', 'h', 'AVILA CARRERA MIGUEL ANGEL', 1, NULL, NULL),
(59, 0, 0, 0, 4, 0, 3, 'Alexander Ichiro', 'CHUMBE BEDRIÑANA', '2015-01-21', 'h', 'BEDRIÑANA SAAVEDRA ROSE NIRA', 1, NULL, NULL),
(60, 0, 0, 0, 4, 0, 4, 'Brunella Franchesca', 'CORDOVA YOPLAC', '2015-01-28', 'm', 'CORDOVA QUISPE ROBER ANGEL', 1, NULL, NULL),
(61, 0, 0, 0, 4, 0, 5, 'Caleb Alan Mathias', 'DEL AGUILA HUAROC', '2015-01-28', 'h', 'HUAROC DICCION YOLANDA ROSARIO', 1, NULL, NULL),
(63, 0, 0, 0, 1, 0, 0, 'Maximo Gabriel', 'Soto Harster', '2014-10-10', 'h', 'Jesus Soto', 0, '2016-01-23 00:00:00', '2016-01-25 00:00:00');
...
INSERT INTO `diagnostico` (`id`, `estado`, `nombre`) VALUES
(0, 1, 'ninguno');
...
CREATE TABLE IF NOT EXISTS `historial` (
  ...
  `idEdad` int(5) NOT NULL,
  `idTalla` int(5) NOT NULL,
  `idPeso` int(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `peso` (
  `id` int(3) NOT NULL,
  `nombre` varchar(100) DEFAULT NULL,
  `cantidad` float(3,2) DEFAULT NULL,
  `estado` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `peso` (`id`, `nombre`, `cantidad`, `estado`) VALUES
(0, 'falta', 0.00, 1);
...
INSERT INTO `talla` (`id`, `nombre`, `cantidad`, `estado`) VALUES
(0, 'falta', 0.00, 1),
(1, '', 5.00, 1);
...
ALTER TABLE `alumno`
  ...
  ADD CONSTRAINT `alumno_ibfk_2` FOREIGN KEY (`idDiagnostico`) REFERENCES `diagnostico` (`id`),
  ADD CONSTRAINT `alumno_ibfk_3` FOREIGN KEY (`idEdad`) REFERENCES `edad` (`id`),
  ADD CONSTRAINT `alumno_ibfk_4` FOREIGN KEY (`idPeso`) REFERENCES `peso` (`id`),
  ADD CONSTRAINT `alumno_ibfk_5` FOREIGN KEY (`idTalla`) REFERENCES `talla` (`id`);
